...
function aircraftIconSvg(kind,model=""){
  ...
  // Compact FR24-inspired silhouettes: aircraft families keep recognizable
  // proportions and visible engine/pod details, while the CSS controls size.
  if(/md 11|dc 10/.test(raw))return base+'<path d="M29 14.2 18.6 11V4.2c0-.9-.7-1.6-1.6-1.6h-2.4c-.9 0-1.6.7-1.6 1.6V11L3 14.2c-.9.3-1.5 1.1-1.5 2.1v1c0 .7.6 1.3 1.3 1.3h9.9v3.6l-3.4 2.5c-.5.4-.8 1-.8 1.6v.5l4.8-1.8 2.3-2.9 2.3 2.9 4.8 1.8v-.5c0-.7-.3-1.3-.8-1.6l-3.4-2.5v-3.6h9.9c.7 0 1.3-.6 1.3-1.3v-1c0-1-.6-1.8-1.5-2.1Z"/><path d="M6.8 14.7h2.5v3.4H6.8zM13.7 14.1h2.5v4h-2.5zM22.7 14.7h2.5v3.4h-2.5z" opacity=".72"/></svg>';
  if(/747/.test(raw))return base+'<path d="M29 14.2 18.5 10.9V5.1c0-.9-.7-1.6-1.6-1.6h-2.1c-.9 0-1.6.7-1.6 1.6v5.8L3 14.2c-.9.3-1.5 1.1-1.5 2v1c0 .7.6 1.3 1.3 1.3h10v3.6l-3.1 2.2c-.6.4-.8 1-.8 1.7v.4l4.7-1.7 1.3-2.5 1.3 2.5 4.7 1.7v-.4c0-.7-.3-1.3-.8-1.7L18 22.1v-3.6h10c.7 0 1.3-.6 1.3-1.3v-1c0-.9-.6-1.7-1.3-2Z"/><path d="M6.9 14.8h2v3.4h-2zM10.8 14.1h2v4h-2zM19.2 14.1h2v4h-2zM23.1 14.8h2v3.4h-2z" opacity=".72"/></svg>';
  if(/a 380|a380/.test(raw))return base+'<path d="M28.8 14.1 18 10.8V4.3c0-.9-.7-1.6-1.6-1.6h-1.8c-.9 0-1.6.7-1.6 1.6v6.5L3.2 14.1c-.9.3-1.5 1.1-1.5 2v1c0 .7.6 1.3 1.3 1.3h10v3.8l-3 2.1c-.5.4-.8 1-.8 1.6v.5l5-1.7 1.4-2.2 1.4 2.2 5 1.7v-.5c0-.6-.3-1.2-.8-1.6l-3-2.1v-3.8h10c.7 0 1.3-.6 1.3-1.3v-1c0-.9-.6-1.7-1.4-2Z"/><path d="M6.7 14.8h2v3.4h-2zM10.2 14.1h2v4h-2zM19.8 14.1h2v4h-2zM23.3 14.8h2v3.4h-2z"/><path d="M7 18.7h18v1.1H7z" opacity=".28"/></svg>';
  if(/a 350|a350|787|777|a 330|a330/.test(raw))return base+'<path d="M28.8 14.1 18 10.9V4.3c0-.9-.7-1.6-1.6-1.6h-1.8c-.9 0-1.6.7-1.6 1.6v6.6L3.2 14.1c-.9.3-1.5 1.1-1.5 2v1c0 .7.6 1.3 1.3 1.3h10v3.6l-3 2.2c-.5.4-.8 1-.8 1.6v.5l4.8-1.7 4.8 1.7v-.5c0-.6-.3-1.2-.8-1.6l-3-2.2v-3.6h10c.7 0 1.3-.6 1.3-1.3v-1c0-.9-.6-1.7-1.4-2Z"/><path d="M8.2 14.8h2.5v3.5H8.2zM21.3 14.8h2.5v3.5h-2.5z" opacity=".72"/></svg>';
  if(/a 320|a320|a 321|a321|a 319|a319|a 318|a318|a 220|a220|737|757|717|727/.test(raw))return base+'<path d="M28 14.6 17.5 11.1V5c0-.8-.6-1.5-1.5-1.5h-2c-.8 0-1.5.7-1.5 1.5v6.1L4 14.6c-.8.3-1.3 1-1.3 1.8v.8c0 .6.5 1.1 1.1 1.1h8.7v3.4l-2.7 1.9c-.5.3-.7.8-.7 1.4v.4l4-1.3 4-1.3v.4c0-.6-.3-1.1-.7-1.4l-2.7-1.9v-3.4h8.7c.6 0 1.1-.5 1.1-1.1v-.8c0-.8-.5-1.5-1.3-1.8Z"/><path d="M9 15.1h2v3.1H9zM21 15.1h2v3.1h-2z" opacity=".72"/></svg>';
  if(/crj|e 170|e170|e 175|e175|e 190|e190|e 195|e195|erj/.test(raw))return base+'<path d="M27.5 14.7 17.2 11.3V5.2c0-.8-.6-1.4-1.4-1.4h-1.6c-.8 0-1.4.6-1.4 1.4v6.1L4.5 14.7c-.8.3-1.2 1-1.2 1.8v.7c0 .6.5 1 1 1h8.6v4l-2.5 1.7c-.5.3-.7.8-.7 1.3v.4l4.7-1.3 4.7 1.3v-.4c0-.5-.3-1-.7-1.3l-2.5-1.7v-4h8.6c.6 0 1-.4 1-1v-.7c0-.8-.4-1.5-1.2-1.8Z"/><path d="M8.7 15.1h2v3.1h-2zM21.3 15.1h2v3.1h-2z" opacity=".72"/></svg>';
  if(/atr|dash 8|dh8|caravan|c 208|c208|king air/.test(raw))return base+'<path d="M26.8 14.8 17.1 11.5V5.5c0-.8-.6-1.4-1.4-1.4h-1.4c-.8 0-1.4.6-1.4 1.4v6L5.2 14.8c-.8.3-1.2.9-1.2 1.7v.6c0 .5.4.9 1 .9h7.9v4l-2.3 1.6c-.4.3-.6.7-.6 1.2v.4l4.2-1.2 4.2 1.2v-.4c0-.5-.2-.9-.6-1.2L17.1 22v-4h7.9c.6 0 1-.4 1-.9v-.6c0-.7-.4-1.4-1.2-1.7Z"/><circle cx="9" cy="16.3" r="2" fill="none" stroke="currentColor" stroke-width="1.2"/><circle cx="23" cy="16.3" r="2" fill="none" stroke="currentColor" stroke-width="1.2"/></svg>';
  if(kind==="helicopter")return base+'<path d="M5 8h22M15.2 9.2v13.6M12 22.8h6.4M10.3 25.2h11.4M7.2 25.2h-3M24.8 25.2h3M15.2 12.2l-3.7 4.2h7.4z"/><circle cx="15.2" cy="8" r="1.7"/><path d="M15.2 19.1c-3.5 0-6.6 1.7-8.3 4.2M15.2 19.1c3.5 0 6.6 4.2 8.3 4.2"/></svg>';
  ...
  return base+'<path d="M28 14.6 17.5 11.1V5c0-.8-.6-1.5-1.5-1.5h-2c-.8 0-1.5.7-1.5 1.5v6.1L4 14.6c-.8.3-1.3 1-1.3 1.8v.8c0 .6.5 1.1 1.1 1.1h8.7v3.4l-2.7 1.9c-.5.3-.7.8-.7 1.4v.4l4-1.3 4 1.3v-.4c0-.6-.3-1.1-.7-1.4l-2.7-1.9v-3.4h8.7c.6 0 1.1-.5 1.1-1.1v-.8c0-.8-.5-1.5-1.3-1.8Z"/></svg>';
}
